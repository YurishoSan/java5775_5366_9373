...
public class DatabaseSqlite extends SQLiteOpenHelper implements Backend
{
	...
	public void onCreate(SQLiteDatabase db)
	{
		...
		CREATE_TABLE = "CREATE TABLE " + SQLNAME.TABLE_ALLERGY + "(" +
				SQLNAME.KEY_ALLERGY_ID + " INTEGER PRIMARY KEY," +
		...
		CREATE_TABLE = "CREATE TABLE " + SQLNAME.TABLE_ALLERGY + "(" +
				...
				SQLNAME.KEY_DOCTOR_GENDER + " TEXT," +
				SQLNAME.KEY_DOCTOR_DOB + " TEXT," +
				SQLNAME.KEY_DOCTOR_EMAIL_ADDRESS + " TEXT," +
				SQLNAME.KEY_DOCTOR_DOJ + " TEXT," +
				SQLNAME.KEY_DOCTOR_SALARY + " REAL," +
				SQLNAME.KEY_DOCTOR_PHONE_NUMBER + " TEXT," +
				SQLNAME.KEY_DOCTOR_SPECIALIZATION + " TEXT" + ")";
		db.execSQL(CREATE_TABLE);
		
		CREATE_TABLE = "CREATE TABLE" + SQLNAME.TABLE_MEDICINE + "(" +
				SQLNAME.KEY_MEDICINE_ID + " INTEGER PRIMARY KEY," +
		...
		CREATE_TABLE = "CREATE TABLE" + SQLNAME.TABLE_MEDICINE_ALLERGY + "(" +
				...
				"constraint pk1 primary key (" + SQLNAME.KEY_MEDICINE_ALLERGY_ALLERGY_ID + ", " + SQLNAME.KEY_MEDICINE_ALLERGY_MEDICINE_ID + ")," +
				"constraint fk1 foreign key (" + SQLNAME.KEY_MEDICINE_ALLERGY_ALLERGY_ID + ") references " + SQLNAME.TABLE_ALLERGY +
				"(" + SQLNAME.KEY_ALLERGY_ID + ")on delete SET NULL ," +
				"constraint fk2 foreign key (" + SQLNAME.KEY_MEDICINE_ALLERGY_MEDICINE_ID + ") references " + SQLNAME.TABLE_MEDICINE +
				"(" + SQLNAME.KEY_MEDICINE_ID + ") on delete SET NULL on update SET NULL)";
		db.execSQL(CREATE_TABLE);
		...
		CREATE_TABLE = "CREATE TABLE" + SQLNAME.TABLE_PASSWORD + "(" +
				...
				"constraint pk1 primary key (" + SQLNAME.KEY_PASSWORD_USER_ID + ", " + SQLNAME.KEY_PASSWORD_WORD + ")," +
				"constraint fk1 foreign key (" + SQLNAME.KEY_PASSWORD_USER_ID + ") references " + SQLNAME.TABLE_DOCTOR +
				"(" + SQLNAME.KEY_DOCTOR_ID + ")on delete SET NULL on update SET NULL)";
		db.execSQL(CREATE_TABLE);
		...
		CREATE_TABLE = "CREATE TABLE" + SQLNAME.TABLE_PATIENT_ALLERGY + "(" +
				...
				"constraint pk1 primary key (" + SQLNAME.KEY_PATIENT_ALLERGY_ALLERGY_ID + ", " + SQLNAME.KEY_PATIENT_ALLERGY_PATIENT_ID + ")," +
				"constraint fk1 foreign key (" + SQLNAME.KEY_PATIENT_ALLERGY_ALLERGY_ID + ") references " + SQLNAME.TABLE_ALLERGY +
				"(" + SQLNAME.KEY_ALLERGY_ID + ")on delete SET NULL ," +
				"constraint fk2 foreign key (" + SQLNAME.KEY_PATIENT_ALLERGY_PATIENT_ID + ") references " + SQLNAME.TABLE_PATIENT +
				"(" + SQLNAME.KEY_PATIENT_ID + ") on delete SET NULL on update SET NULL)";
		db.execSQL(CREATE_TABLE);
		...
		CREATE_TABLE = "CREATE TABLE" + SQLNAME.TABLE_PRESCRIPTION + "(" +
				...
				SQLNAME.KEY_PRESCRIPTION_MEDICINE_EXPERATION_DATE + " STRING," +
				"constraint pk1 primary key (" + SQLNAME.KEY_PRESCRIPTION_TREATMENT_ID + ", " + SQLNAME.KEY_PRESCRIPTION_MEDICINE_ID + ")," +
				"constraint fk1 foreign key (" + SQLNAME.KEY_PRESCRIPTION_TREATMENT_ID + ") references " + SQLNAME.TABLE_TREATMENT +
				"(" + SQLNAME.KEY_TREATMENT_ID + ")on delete SET NULL ," +
				"constraint fk2 foreign key (" + SQLNAME.KEY_PRESCRIPTION_MEDICINE_ID + ") references " + SQLNAME.TABLE_MEDICINE +
				"(" + SQLNAME.KEY_MEDICINE_ID + ") on delete SET NULL on update SET NULL)";
		db.execSQL(CREATE_TABLE);
		...
		CREATE_TABLE = "CREATE TABLE" + SQLNAME.TABLE_PATIENT + "(" +
				...
				"constraint fk1 foreign key (" + SQLNAME.KEY_TREATMENT_DOCTOR_ID + ") references " + SQLNAME.TABLE_DOCTOR +
				"(" + SQLNAME.KEY_DOCTOR_ID + ")on delete SET NULL ," +
				"constraint fk2 foreign key (" + SQLNAME.KEY_TREATMENT_PATIENT_ID + ") references " + SQLNAME.TABLE_PATIENT +
				"(" + SQLNAME.KEY_PATIENT_ID + ") on delete SET NULL on update SET NULL)";
	...
	public void addAllergy(Allergy allergy) throws Exception
	{
		...
		db.insertWithOnConflict(SQLNAME.TABLE_ALLERGY, null, values, SQLiteDatabase.CONFLICT_IGNORE);
		db.close();
	...
	public void addDoctor(Doctor doctor) throws Exception
	{
		...
		values.put(SQLNAME.KEY_DOCTOR_DOB, dateFormat.format(doctor.getDoctorDoB()));
		values.put(SQLNAME.KEY_DOCTOR_EMAIL_ADDRESS, doctor.getDoctorEmailAdress());
		values.put(SQLNAME.KEY_DOCTOR_DOJ, dateFormat.format(doctor.getDoctorDoJ()));
		values.put(SQLNAME.KEY_DOCTOR_SALARY, doctor.getDoctorSalary());
		values.put(SQLNAME.KEY_DOCTOR_PHONE_NUMBER, doctor.getDoctorPhoneNumber());
		values.put(SQLNAME.KEY_DOCTOR_SPECIALIZATION, doctor.getDoctorSpecialization().name());
	...
	public void addMedicine(Medicine medicine) throws Exception
	{
		...
		values.put(SQLNAME.KEY_MEDICINE_INGREDIENTS, medicine.getMedicineIngredients());
		values.put(SQLNAME.KEY_MEDICINE_ACTIVE_INGREDIENTS, medicine.getMedicineActiveIngredients());
			...
			throws Exception
	{
		...
		values.put(SQLNAME.KEY_MEDICINE_ALLERGY_MEDICINE_ID, medicineAllergy.getMedicineID());
		values.put(SQLNAME.KEY_MEDICINE_ALLERGY_ALLERGY_ID, medicineAllergy.getAllergyID());
		
		db.insertWithOnConflict(SQLNAME.TABLE_MEDICINE_ALLERGY, null, values, SQLiteDatabase.CONFLICT_IGNORE);
		db.close();
	...
	public void addPassword(Password password) throws Exception
	{
		...
		if (checkPassword(password.getPasswordUserID(), password.getPasswordWord()) != Permit.DENIED) // user can have only one password
		...
		values.put(SQLNAME.KEY_PASSWORD_PERMIT, password.getPasswordPermit().name());
	...
	public void addPatient(Patient patient) throws Exception
	{
		...
		values.put(SQLNAME.KEY_PATIENT_FIRST_NAME, patient.getPatientFirstName());
		values.put(SQLNAME.KEY_PATIENT_LAST_NAME, patient.getPatientLastName());
		values.put(SQLNAME.KEY_PATIENT_GENDER, patient.getPatientGender().name());
		values.put(SQLNAME.KEY_PATIENT_DOB, dateFormat.format(patient.getPatientDoB()));
		values.put(SQLNAME.KEY_PATIENT_EMAIL_ADDRESS, patient.getPatientEmailAdress());
		values.put(SQLNAME.KEY_PATIENT_SERVICE_CLASS, patient.getPatientServiceClass().name());
		values.put(SQLNAME.KEY_PATIENT_PHONE_NUMBER, patient.getPatientPhoneNumber());
			...
			throws Exception
	{
		...
		values.put(SQLNAME.KEY_PATIENT_ALLERGY_PATIENT_ID, patientAllergy.getPatientID());
		values.put(SQLNAME.KEY_PATIENT_ALLERGY_ALLERGY_ID, patientAllergy.getAllergyID());
		
		db.insertWithOnConflict(SQLNAME.TABLE_PATIENT_ALLERGY, null, values, SQLiteDatabase.CONFLICT_IGNORE);
		db.close();
	...
	public void addPrescription(Prescription prescription) throws Exception
	{
		...
		values.put(SQLNAME.KEY_PRESCRIPTION_TREATMENT_ID, prescription.getPrescriptionTreatmentID());
		values.put(SQLNAME.KEY_PRESCRIPTION_MEDICINE_ID, prescription.getPrescriptionMedicineID());
		values.put(SQLNAME.KEY_PRESCRIPTION_MEDICINE_EXPERATION_DATE, dateFormat.format(prescription.getPrescriptionMedicineExperationDate()));
		
		db.insertWithOnConflict(SQLNAME.TABLE_PRESCRIPTION, null, values, SQLiteDatabase.CONFLICT_IGNORE);
		db.close();
	...
	public void addTreatment(Treatment treatment) throws Exception
	{
		...
		values.put(SQLNAME.KEY_TREATMENT_DOCTOR_ID, treatment.getTreatmentDoctorID());
		values.put(SQLNAME.KEY_TREATMENT_PATIENT_ID, treatment.getTreatmentPatientID());
		values.put(SQLNAME.KEY_TREATMENT_DATE, dateFormat.format(treatment.getTreatmentDate()));
		values.put(SQLNAME.KEY_TREATMENT_LOCATION, treatment.getTreatmentLocation());
		values.put(SQLNAME.KEY_TREATMENT_SUMMARY, treatment.getTreatmentSummary());
		values.put(SQLNAME.KEY_TREATMENT_DONE, (treatment.isTreatmentDone())? 1 : 0);
		
		db.insertWithOnConflict(SQLNAME.TABLE_TREATMENT, null, values, SQLiteDatabase.CONFLICT_IGNORE);
		db.close();
	}
	...
	{
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(SQLNAME.TABLE_ALLERGY, SQLNAME.KEY_ALLERGY_ID + " = ?", new String[] { String.valueOf(allergyID) });
	...
	{
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(SQLNAME.TABLE_DOCTOR, SQLNAME.KEY_DOCTOR_ID + " = ?", new String[] { String.valueOf(doctorID) });
	...
	{
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(SQLNAME.TABLE_MEDICINE, SQLNAME.KEY_MEDICINE_ID + " = ?", new String[] { String.valueOf(medicineID) });
	...
	{
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(SQLNAME.TABLE_PATIENT, SQLNAME.KEY_PATIENT_ID + " = ?", new String[] { String.valueOf(patientID) });
	...
	{
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(SQLNAME.TABLE_TREATMENT, SQLNAME.KEY_TREATMENT_ID + " = ?", new String[] { String.valueOf(treatmentID) });
	...
	{
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(SQLNAME.TABLE_MEDICINE_ALLERGY, SQLNAME.KEY_MEDICINE_ALLERGY_MEDICINE_ID + " = ?", new String[] { String.valueOf(medicineID) });
	}
	...
	{
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(SQLNAME.TABLE_PATIENT_ALLERGY, SQLNAME.KEY_PATIENT_ALLERGY_PATIENT_ID + " = ?", new String[] { String.valueOf(patientID) });
	...
	{
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(SQLNAME.TABLE_PATIENT_ALLERGY, SQLNAME.KEY_PATIENT_ALLERGY_ALLERGY_ID + " = ?", new String[] { String.valueOf(allergyID) });
	...
	{
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(SQLNAME.TABLE_PRESCRIPTION, SQLNAME.KEY_PRESCRIPTION_MEDICINE_ID + " = ?", new String[] { String.valueOf(medicineID) });
	...
	{
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(SQLNAME.TABLE_PRESCRIPTION, SQLNAME.KEY_PRESCRIPTION_TREATMENT_ID + " = ?", new String[] { String.valueOf(treatmentID) });
	}
	...
	public void updateAllergy(Allergy allergy) throws Exception
	{
		...
		db.update(SQLNAME.TABLE_ALLERGY, values, SQLNAME.KEY_ALLERGY_ID + " = ?", new String[] { String.valueOf(allergy.getAllergyID()) });
		db.close();
	}
	...
	public void updateDoctor(Doctor doctor) throws Exception
	{
		...
		db.update(SQLNAME.TABLE_DOCTOR, values, SQLNAME.KEY_DOCTOR_ID + " = ?", new String[] { String.valueOf(doctor.getDoctorID()) });
		db.close();
	...
	public void updateMedicine(Medicine medicine) throws Exception
	{
		...
		db.update(SQLNAME.TABLE_ALLERGY, values, SQLNAME.KEY_ALLERGY_ID + " = ?", new String[] { String.valueOf(medicine.getMedicineID()) });
		db.close();

	}

	/* (non-Javadoc)
	 * @see model.backend.Backend#updateMedicineAllergy(entities.MedicineAllergy)
	 */
	@Override
			...
			throws Exception
	{
		...
		//db.update(SQLNAME.TABLE_MEDICINE_ALLERGY, values, /* what check goes here? */);
		db.close();

	}

	/* (non-Javadoc)
	 * @see model.backend.Backend#updatePassword(entities.Password, java.lang.String)
	 */
	@Override
			...
			throws Exception
	{
		...
		if (checkPassword(oldPassword.getPasswordUserID(), oldPassword.getPasswordWord()) == Permit.DENIED)
			throw new Exception("סיסמה שגויה");
		
		values.put(SQLNAME.KEY_PASSWORD_WORD, newPassword);

		db.update(SQLNAME.TABLE_PASSWORD, values, SQLNAME.KEY_PASSWORD_USER_ID + " = ?", new String[] { String.valueOf(oldPassword.getPasswordUserID()) });
		db.close();
	}

	/* (non-Javadoc)
	 * @see model.backend.Backend#updatePassword(entities.Password, java.lang.String, entities.enums.Permit)
	 */
	@Override
	public void updatePassword(Password oldPassword, String newPassword,
	...
	public void updatePatient(Patient patient) throws Exception
	{
		...
		db.update(SQLNAME.TABLE_PATIENT, values, SQLNAME.KEY_PATIENT_ID + " = ?", new String[] { String.valueOf(patient.getPatientID()) });
		db.close();
			...
			throws Exception
	{
		...
		//db.update(SQLNAME.TABLE_PATIENT_ALLERGY, values, /* what check goes here? */);
		db.close();
	...
	public void updatePrescription(Prescription prescription) throws Exception
	{
		...
		//db.update(SQLNAME.TABLE_PRESCRIPTION, values, /* what check goes here? */);
		db.close();
	...
	public void updateTreatment(Treatment treatment) throws Exception
	{
		...
		db.update(SQLNAME.TABLE_TREATMENT, values, SQLNAME.KEY_TREATMENT_ID + " = ?", new String[] { String.valueOf(treatment.getTreatmentID()) });
		db.close();
	...
	{
		ArrayList<Allergy> allergyList = new ArrayList<Allergy>();
		String selectQuery = "SELECT * FROM " + SQLNAME.TABLE_ALLERGY + " tAllergy, " +
				SQLNAME.TABLE_PATIENT + " tPatient, " + SQLNAME.TABLE_PATIENT_ALLERGY + " tAllergyPatient " +
				"WHERE tPatient." + SQLNAME.KEY_PATIENT_ID + " = '" + patientID + "'" +
				" AND tPatient." + SQLNAME.KEY_PATIENT_ID + " = " + "tAllergyPatient." + SQLNAME.KEY_PATIENT_ALLERGY_PATIENT_ID +
				" AND tAllergy." + SQLNAME.KEY_ALLERGY_ID + " = " + "tAllergyPatient." + SQLNAME.KEY_PATIENT_ALLERGY_ALLERGY_ID;
		SQLiteDatabase db = this.getReadableDatabase();
			...
			throws Exception
	{
		ArrayList<Allergy> allergyList = new ArrayList<Allergy>();
		String selectQuery = "SELECT * FROM " + SQLNAME.TABLE_ALLERGY + " tAllergy, " +
				SQLNAME.TABLE_MEDICINE + " tMedicine, " + SQLNAME.TABLE_MEDICINE_ALLERGY + " tAllergyMedicine " +
				"WHERE tMedicine." + SQLNAME.KEY_MEDICINE_ID + " = '" + medicineID + "'" +
				" AND tMedicine." + SQLNAME.KEY_MEDICINE_ID + " = " + "tAllergyMedicine." + SQLNAME.KEY_MEDICINE_ALLERGY_MEDICINE_ID +
				" AND tAllergy." + SQLNAME.KEY_ALLERGY_ID + " = " + "tAllergyMedicine." + SQLNAME.KEY_MEDICINE_ALLERGY_ALLERGY_ID;
		SQLiteDatabase db = this.getReadableDatabase();
	...
	public ArrayList<Doctor> getDoctorList() throws Exception
	{
		...
		if (cursor.moveToFirst())
		{
			...
			{		
				...
				doctor.setDoctorSpecialization(Specialization.valueOf(cursor.getString(9)));
	...
	public ArrayList<Medicine> getMedicineList() throws Exception
	{
		...
		if (cursor.moveToFirst())
		{
			...
			{		
				...
				medicine.setMedicineType(MedicineType.valueOf(cursor.getString(4)));
	...
	{
		ArrayList<Medicine> medicineList = new ArrayList<Medicine>();
		String selectQuery = "SELECT * FROM " + SQLNAME.TABLE_MEDICINE + " tMedicine, " +
				SQLNAME.TABLE_TREATMENT + " tTreatment, " + SQLNAME.TABLE_PRESCRIPTION + " tPrescription " +
				"WHERE tTreatment." + SQLNAME.KEY_TREATMENT_ID + " = '" + treatmentID + "'" +
				" AND tMedicine." + SQLNAME.KEY_MEDICINE_ID + " = " + "tPrescription." + SQLNAME.KEY_PRESCRIPTION_MEDICINE_ID +
				" AND tTreatment." + SQLNAME.KEY_TREATMENT_ID + " = " + "tPresrcription." + SQLNAME.KEY_PRESCRIPTION_TREATMENT_ID;
		SQLiteDatabase db = this.getReadableDatabase();
	...
	public ArrayList<Patient> getPatientList() throws Exception
	{
		...
		if (cursor.moveToFirst())
		{
			...
			{		
				...
				patient.setPatientServiceClass(ServiceClass.valueOf(cursor.getString(6)));
	...
	private ArrayList<MedicineAllergy> getMedicineAllergyList() throws ParseException
	{
	...
	private ArrayList<Prescription> getPrescriptionList() throws Exception
	{
		...
		{		
			...
			prescription.setPrescriptionMedicineExperationDate(dateFormat.parse(cursor.getString(2)));
